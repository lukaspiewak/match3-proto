...
export class InputController {
    ...
    constructor(logic: BoardLogic, app: PIXI.Application) {
        this.logic = logic;
        this.app = app;
    ...
    private onDown(e: PIXI.FederatedPointerEvent) {
        // Konwersja Pixeli na Siatkę
        const boardX = 20; // Margines z Renderera
        const boardY = 20;
        
        const col = Math.floor((e.global.x - boardX) / TILE_SIZE);
        const row = Math.floor((e.global.y - boardY) / TILE_SIZE);
